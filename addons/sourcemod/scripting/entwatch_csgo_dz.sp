...
#include "entwatch/module_client_menu.inc"
...
public void OnPluginStart()
{
	...
	//Timers
	CreateTimer(60.0,DisplayEntitys,_,TIMER_REPEAT); 
	...
	#if defined EW_MODULE_CLIENTMENU
	EWM_Client_MenuOnPluginStart();
	#endif
...
stock void LoadScheme()
{
	...
	g_SchemeConfig.Pos_HUD_X		= 0.6;
	g_SchemeConfig.Pos_HUD_Y		= 0.3;
	...
	g_SchemeConfig.Pos_HUD_X = KvConfig.GetFloat("pos_hud_x",0.6);
	g_SchemeConfig.Pos_HUD_Y = KvConfig.GetFloat("pos_hud_y",0.3);
	#endif
...
public Action DisplayEntitys(Handle timer)
{
	g_iServer_entitys = 0;
	...
	PrintToChatAll(" [\x05Server\x01]Current Edicts \x04%d\x01,MAX:2048",g_iServer_entitys);
